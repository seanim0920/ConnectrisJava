...
class Load extends Thread {
    public void run(final Main game) {
        ...
        game.manager.load("preview/b.png", Texture.class);
        game.manager.load("preview/i.png", Texture.class);
        game.manager.load("preview/l.png", Texture.class);
        game.manager.load("preview/r.png", Texture.class);
        game.manager.load("preview/t.png", Texture.class);
        game.manager.load("preview/p.png", Texture.class);
        ...
        game.preview.add(game.manager.get("preview/i.png", Texture.class));
        game.preview.add(game.manager.get("preview/l.png", Texture.class));
        game.preview.add(game.manager.get("preview/r.png", Texture.class));
        game.preview.add(game.manager.get("preview/t.png", Texture.class));
        game.preview.add(game.manager.get("preview/p.png", Texture.class));
        game.preview.add(game.manager.get("preview/b.png", Texture.class));
