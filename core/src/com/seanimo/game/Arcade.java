...
public class Arcade extends com.seanimo.game.Unit implements Screen {
    FreeTypeFontGenerator.FreeTypeFontParameter parameter = new FreeTypeFontGenerator.FreeTypeFontParameter();
    BitmapFont font;

    private Array<com.seanimo.game.Tile> corners = new Array<com.seanimo.game.Tile>();
    private int dframes = 0;

    private int tiles = 0;
    private int max = 100;
    private int flux = 0;
    private com.seanimo.game.Label label;
    private com.seanimo.game.Label label2;
    private com.seanimo.game.Label label3;
    private com.seanimo.game.Label label4;
    ...
    private com.seanimo.game.ImageButton down;
    private com.seanimo.game.ImageButton rturn;
    private com.seanimo.game.ImageButton lturn;
    ...
    private com.seanimo.game.Tile current = null;
    ...
    private Array<com.seanimo.game.Tile> dblocks = new Array<com.seanimo.game.Tile>();

    //to generate new tiles
    private com.seanimo.game.Tile newTile() {
        com.seanimo.game.Tile tile;
        tile = new com.seanimo.game.Tile(com.seanimo.game.Type.valueOf(next));
        //if (current != null)
    ...
    public Arcade(final com.seanimo.game.Main game, final Music music) {
        super(game);
        prepare();
    ...
    private void drawField() {
        ...
        for (int x = s; x < e; x++) {
            for (int y = ceiling; y >= 0; y--) {
                updateTile(field[((x%field.length)+field.length)%field.length][y]);
            }
        }
    ...
    private void drawParticles() {
        ...
        for (int i = 0; i < dblocks.size; i++) {
            com.seanimo.game.Tile block = dblocks.get(i);
    ...
    private void checktion(com.seanimo.game.Tile tile) {
        boolean containsLoop = false;
        //use BFS to see if the graph is connected
        Array<com.seanimo.game.Tile> caught = new Array<com.seanimo.game.Tile>();
        Array<com.seanimo.game.Tile> graph = new Array<com.seanimo.game.Tile>();
        Array<com.seanimo.game.Tile> stack = new Array<com.seanimo.game.Tile>();
        stack.add(tile);
        graph.add(tile);
        while (stack.size > 0) {
            ...
            for (int i = 0; i < 4; i++) {
                if (ctile.sides[i]) {
                    ...
                    com.seanimo.game.Tile chtile = getTile(chcoords);
